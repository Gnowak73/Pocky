...
if __name__ == "__main__":
    ...
    query_start_time_utc = "2026-02-04T11:10:00Z"
    # Separate controls:
    ...
    x_top = np.array([-450, -80, 830])  # heliographic X
    ...
    # waffle_v3 is intentionally fixed to one main legacy trigger model and one GRU pretrigger model.
    imminence_model_path = resolve_imminence_model_path("legacy_main_trigger.pt")
    imminence_pretrigger_model_path = resolve_imminence_model_path(
        "gru_pretrigger_10m.pt"
    )
    ...
    imminence_pretrigger_avg10_threshold = 0.70
    ...
    try:
        ...
        aux_functions.stream_aia_data(
            ...
            imminence_pretrigger_model_path=imminence_pretrigger_model_path,
            ...
            imminence_pretrigger_avg10_threshold=imminence_pretrigger_avg10_threshold,
            ...
            imminence_pretrigger_cooldown_frames=imminence_pretrigger_cooldown_frames,
