...
def _infer_imminence_risk_from_history(vis_history, runtime, em_history=None):
                ...
                if imminence_runtime:
                    ...
                    for i in range(n_ar):
                        ...
                        risk_val, prob_val = _infer_imminence_risk_from_history(
                            vis_history[box_label], imminence_runtime, em_history[box_label]
                        )
                        ...
                        if len(recent_vals) >= int(imminence_alert_count):
                            ...
                            triggered = avg_ok and peak_ok and delta_ok and em_ok and area_ok and physical_trend_ok
                            if i == focus_idx:
