...
This is the minimal subset of the training module required to reconstruct the
saved PyTorch model and engineer the latest feature vector at runtime. Training,
evaluation, dataset splitting, and CLI code stay in ``ML_FFT``.
"""
